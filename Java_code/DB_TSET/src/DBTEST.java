...
public class DBTEST {
	...
	// https://developers.naver.com/docs/common/openapiguide/apicall.md <-- 자바 REST API 관련!! 
	...
	public static void GET(String requestURL) {
        ...
        try {
            ...
            while ((inputLine = br.readLine()) != null) {
            	...
            	StringTokenizer str = new StringTokenizer(inputLine, ","); //StringTokenizer 클래스 생성, 파싱하려는 문자열, 구분자 "," 
 
            	
            	while (str.hasMoreTokens()) {
            		// https://lifeones.tistory.com/89 <-- 자바 파싱 관련!! 
